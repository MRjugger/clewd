...
/******************************** */
                        if (apiKey) {
                            ...
                            if (messagesAPI) {
                                ...
                                messages = [{role: 'user', content: Config.Settings.FullColon ? userMessage.trim() : userMessage.replace(/\n\n(Human|Assistant):/g, '\n\r\n$1:').trim()}, assistantMessage && {role: 'assistant', content: assistantMessage.trim()}].filter(Boolean), system = splitHuman[0].trim();
                            }
